class Rectangle {
    ...
    draw(context) {
        ...
        if (this.text != undefined){
            ...
            context.fillText(this.text, this.x  + offsetX + (this.width - context.measureText(this.text).width) / 2, this.y  + offsetY + (this.height + getFontSize(context) / 2) / 2);    
        } 
    }
    ...
    containsPoint(point) {
        return point.X > this.x + offsetX && point.X < this.x + offsetX + this.width &&
            point.Y > this.y + offsetY && point.Y < this.y + offsetY + this.height;
    }
    ...
    createAlcas(context) {
        ...
        alcasArray.push(new Alca(this.x + offsetX - larguraDaAlca / 2, this.y + offsetY - alturaDaAlca / 2, larguraDaAlca, alturaDaAlca, this, id, -1, -1));
        id++;
        alcasArray.push(new Alca(this.x + offsetX - larguraDaAlca / 2, this.y + offsetY + this.height - larguraDaAlca / 2, larguraDaAlca, alturaDaAlca, this, id, -1, 1));
        id++;
        alcasArray.push(new Alca(this.x + offsetX + this.width - larguraDaAlca / 2, this.y + offsetY - alturaDaAlca / 2, larguraDaAlca, alturaDaAlca, this, id, 1, -1));
        id++;
        alcasArray.push(new Alca(this.x + offsetX + this.width - larguraDaAlca / 2, this.y + offsetY + this.height - alturaDaAlca / 2, larguraDaAlca, alturaDaAlca, this, id, 1, 1));

        id++;
        alcasArray.push(new Alca(this.x + offsetX + (this.width - larguraDaAlca) / 2, this.y + offsetY - alturaDaAlca  / 2, larguraDaAlca, alturaDaAlca, this, id, 0, -1));
        id++;
        alcasArray.push(new Alca(this.x + offsetX - larguraDaAlca / 2, this.y + offsetY + (this.height - alturaDaAlca) / 2, larguraDaAlca, alturaDaAlca, this, id, -1, 0));
        id++;
        alcasArray.push(new Alca(this.x + offsetX + (this.width - larguraDaAlca) / 2, this.y + offsetY + this.height  - alturaDaAlca / 2, larguraDaAlca, alturaDaAlca, this, id, 0, 1));
        id++;
        alcasArray.push(new Alca(this.x + offsetX + this.width - larguraDaAlca / 2, this.y + offsetY + (this.height - alturaDaAlca) / 2, larguraDaAlca, alturaDaAlca, this, id, 1, 0));
