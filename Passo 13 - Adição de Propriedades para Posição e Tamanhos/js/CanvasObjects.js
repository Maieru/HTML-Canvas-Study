class Rectangle {
    constructor(x, y, width, height, color, text) {
        ...
        this.x = {
            ...
            get relative() { return this.internalX + offsetX }
        };
        this.y = {
            internalY: y,
            get absolute() { return this.internalY },
            set absolute(newValue) { this.internalY = newValue },
            get relative() { return this.internalY + offsetY }
        };
        this.text = text;
        this.color = color;
        this.width = {
...
class Alca {
    ...
    move(context, mouseVariations) {
        ...
        if (this.coeficienteY == -1) {
            this.fatherElement.y.absolute.absolute += mouseVariations.Y;
